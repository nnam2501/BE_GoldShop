# Generated by Django 4.0.4 on 2022-05-18 03:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jewerlyImage', models.ImageField(blank=True, upload_to='uploads/jewerly')),
                ('active', models.BooleanField(default=True)),
                ('supplier', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.supplier')),
                ('typeJewerly', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.typejewerly')),
            ],
        ),
        migrations.CreateModel(
            name='User',
